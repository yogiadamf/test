...
const Resume = (props) => {
  ...
  const projectsDetails = [
    ...
    {
      title: "Website Reservation Caffe Sloor.in",
      duration: { fromDate: "Agu 2020", toDate: "Sep 2020" },
      description:
        "A website reservation and inventory management",
      subHeading:
        "Technologies Used:  Laravel & MySQL",
    },
    {
      title: "Network Desaign CV. Barokah ZA",
      duration: { fromDate: "Jan 2020", toDate: "Feb 2020" },
      description:
        "Optimisation network desaign using cisco packet tracer",
      subHeading:
  ...
  const resumeDetails = [
    <div className="resume-screen-container" key="education">
      <ResumeHeading
        heading={"UNIVERSITAS INTERNASIONAL SEMEN INDONESIA"}
      ...
      <ResumeHeading
        heading={"SMAN 1 SUGIHWARAS"}
        subHeading={"NATURAL SCIENCE"}
        fromDate={"2014"}
        toDate={"2017"}
      />
      <ResumeHeading
        heading={"SMPN 2 BALEN"}
        subHeading={""}
        fromDate={"2011"}
        toDate={"2014"}
      />
    ...
    <div className="resume-screen-container" key="work-experience">
      <div className="experience-container">
        <ResumeHeading
          ...
          subHeading={"IT SPECIALIST INTERNSHIP"}
          fromDate={"Agu 2020"}
          toDate={"Sep 2020"}
        />
